...
(function () {
  ...
  return {
    ...
    toReadable: function toReadable(schedule) {
      var result = [];
    ...
    minsktrans: function minsktrans(schedule) {
      schedule = schedule.split('\n');
      var sections = {};
      schedule.forEach(function (row, id) {
        var periods = _.compact(row.split('	')); // Если строка - шапка, то сохраняем названия секций и продолжаем
    ...
    transnavigation: function transnavigation(schedule) {
      schedule = schedule.split('\n');
      var data = {};
      var lastHour;
